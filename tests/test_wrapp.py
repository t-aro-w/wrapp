...
def test_app():
    ...
    expect_lines = [
            'wrapp.py:86 in_file= in_file',
            'wrapp.py:86 out_dir= None',
            'wrapp.py:86 option= True',
            'template.py:30 info',
...
def test_cli():
    ...
    expect_lines = [
            '__main__.py:86 in_file= in_file',
            '__main__.py:86 out_dir= None',
            '__main__.py:86 option= True',
            'template.py:30 info',
            'template.py:31 warning',
            'template.py:32 error',
            'template.py:33 critical',
